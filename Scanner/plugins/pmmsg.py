...
async def pmPermit(client: ubot, message: Message):
  await ubot.send_message(message.chat.id,f"Hey 👋 I am the assistant of Dusky X System Bot, didn't have a time to talk with you 🙂 kindly join @{SUPPORT_CHAT} for getting Support.")
  return
